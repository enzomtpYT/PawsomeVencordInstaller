$DOWNLOAD_CLI = "https://github.com/enzomtpYT/PawsomeVencordInstaller/releases/latest/download/PawsomeVencordInstallerCli.exe"
$DOWNLOAD_GUI = "https://github.com/enzomtpYT/PawsomeVencordInstaller/releases/latest/download/PawsomeVencordInstaller.exe"

if ([Environment]::Is64BitOperatingSystem -and [System.Environment]::OSVersion.Version.Major -ge 10) {
	Write-Output "====================================="
	Write-Output "|      PawsomeVencord Installer     |"
	Write-Output "====================================="
	Write-Output ""
...
if ($choice -eq 2) {
	...
	Write-Output "1) Install PawsomeVencord"
	Write-Output "2) Install OpenAsar"
	Write-Output "3) Uninstall PawsomeVencord"
	Write-Output "4) Uninstall OpenAsar"
	Write-Output "5) Reinstall & Update PawsomeVencord"
	Write-Output "Q) Quit without doing anything"
	Write-Output ""
	$choice = Read-Host "Please choose by typing a number or Q"
